...
import DocumentCard from '@/components/DocuemntCard';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Browse and find the perfect template for your document needs." />
      </Head>
      <div className="min-h-screen flex flex-col">
        {/* <Header /> */}
        
        <main className="flex-1 pt-10 pb-20 px-6 md:px-12 bg-background">
